...
const Textarea = ({ ...props }) => (
  <textarea
    className="w-full px-3 py-2 rounded-md bg-gray-800 border border-gray-700 text-white outline-none focus:ring-2 focus:ring-gray-600 resize-none"
    {...props}
  />
);
              ...
              {tabs.map((tab) => {
                ...
                return (
                  <button
                    ...
                    className={`flex items-center gap-2 px-4 py-2.5 rounded-md text-sm font-medium whitespace-nowrap transition ${activeTab === tab.id
            ...
            <div className=" p-4 rounded-md  space-y-4 ">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <input
                        type="file"
                        accept="image/*"
                        className="w-full text-white file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-medium file:bg-blue-600 file:text-white hover:file:bg-blue-500 cursor-pointer"
                    ...
                    {logoPreview && (
                      <div className="mt-4">
                        ...
                        <img
                          src={logoPreview}
                          alt="Logo preview"
                          className="max-h-32 rounded-md border border-gray-700"
                        />
                      </div>
                    )}
                  </div>
              ...
              {activeTab === "smtp" && (
                <>
                  ...
                  <div className="grid grid-cols-1 gap-5 md:grid-cols-2">
                    ...
                    <div className="md:col-span-2">
                      ...
                      <select
                        ...
                        className="w-full rounded-md border border-gray-700 bg-gray-800 px-3 py-2 text-white outline-none focus:ring-2 focus:ring-blue-600"
                      >
                  ...
                  {/* Test Email */}
                  {/* <div className="mt-8 flex items-center justify-between rounded-md border border-blue-600/20 bg-blue-600/5 p-5">
